...
connect_dict = {
    ...
    "R7": [{"port": 1, "sw_ind": "R2"}, {"port": 2, "sw_ind": "R3"}],
    "R8": [
        {"port": 1, "sw_ind": "R5"},
        {"port": 2, "sw_ind": "R3"},
        {"port": 3, "sw_ind": "R16"},
    ...
    "R9": [{"port": 1, "sw_ind": "R4"}, {"port": 2, "sw_ind": "R5"}],
    "R10": [{"port": 1, "sw_ind": "R1"}, {"port": 2, "sw_ind": "R4"}],
    "R11": [{"port": 1, "sw_ind": "R1"}, {"port": 2, "sw_ind": "R2"}],
    "R12": [{"port": 1, "sw_ind": "R2"}, {"port": 2, "sw_ind": "R3"}],
    "R13": [{"port": 1, "sw_ind": "R4"}, {"port": 2, "sw_ind": "R1"}],
    "R14": [{"port": 1, "sw_ind": "R1"}],
    "R15": [{"port": 1, "sw_ind": "R1"}],
    "R16": [{"port": 1, "sw_ind": "R8"}, {"port": 2, "sw_ind": "R6"}],
    "R17": [{"port": 1, "sw_ind": "R8"}, {"port": 2, "sw_ind": "R6"}],
}
